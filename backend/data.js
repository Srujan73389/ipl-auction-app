// Export teams, samplePlayers and userAccounts for seeding and server use
const samplePlayers = [
  // ============ ORIGINAL 12 PLAYERS (with photos) ============
  { id: 1, name: 'Virat Kohli', role: 'Batsman', country: '🇮🇳 India', basePrice: 2, caps: 237, avg: 36.2, sr: 131.4, runs: 7263, grade: 'A+', bg: 'from-red-900 to-red-700', photo: '/players/virat-kohli.webp', formerTeam: 'RCB', t20Rating: 97, fairVal: 18.5 },
  { id: 2, name: 'Rohit Sharma', role: 'Batsman', country: '🇮🇳 India', basePrice: 2, caps: 243, avg: 29.5, sr: 130.1, runs: 6211, grade: 'A+', bg: 'from-blue-900 to-blue-700', photo: '/players/rohit-sharma.webp', formerTeam: 'MI', t20Rating: 95, fairVal: 16.0 },
  { id: 3, name: 'Jasprit Bumrah', role: 'Bowler', country: '🇮🇳 India', basePrice: 2, caps: 131, wickets: 145, economy: 7.4, avg: 21.3, grade: 'A+', bg: 'from-indigo-900 to-indigo-700', photo: '/players/bumrah.webp', formerTeam: 'MI', t20Rating: 99, fairVal: 19.0 },
  { id: 4, name: 'MS Dhoni', role: 'Wicketkeeper', country: '🇮🇳 India', basePrice: 2, caps: 250, avg: 38.1, sr: 135.9, runs: 5082, grade: 'LEGEND', bg: 'from-yellow-900 to-yellow-700', photo: '/players/dhoni.webp', formerTeam: 'CSK', t20Rating: 98, fairVal: 15.0 },
  { id: 5, name: 'KL Rahul', role: 'Batsman', country: '🇮🇳 India', basePrice: 2, caps: 115, avg: 46.1, sr: 134.9, runs: 4683, grade: 'A', bg: 'from-teal-900 to-teal-700', photo: '/players/kl-rahul.webp', formerTeam: 'LSG', t20Rating: 91, fairVal: 14.0 },
  { id: 6, name: 'Hardik Pandya', role: 'All-Rounder', country: '🇮🇳 India', basePrice: 2, caps: 115, avg: 28.9, sr: 143.2, wickets: 67, grade: 'A', bg: 'from-orange-900 to-orange-700', photo: '/players/hardik-pandya.webp', formerTeam: 'MI', t20Rating: 93, fairVal: 15.5 },
  { id: 7, name: 'Suryakumar Yadav', role: 'Batsman', country: '🇮🇳 India', basePrice: 2, caps: 147, avg: 33.2, sr: 160.4, runs: 3282, grade: 'A+', bg: 'from-cyan-900 to-cyan-700', photo: '/players/suryakumar-yadav.webp', formerTeam: 'MI', t20Rating: 98, fairVal: 17.5 },
  { id: 8, name: 'Rashid Khan', role: 'Bowler', country: '🇦🇫 Afghanistan', basePrice: 2, caps: 122, wickets: 166, economy: 6.6, avg: 17.8, grade: 'A+', bg: 'from-green-900 to-green-700', photo: '/players/rashid-khan.webp', formerTeam: 'GT', t20Rating: 97, fairVal: 16.5 },
  { id: 9, name: 'Jos Buttler', role: 'Wicketkeeper', country: '🏴󠁧󠁢󠁥󠁮󠁧󠁿 England', basePrice: 2, caps: 94, avg: 38.9, sr: 149.7, runs: 3582, grade: 'A', bg: 'from-purple-900 to-purple-700', photo: '/players/jos-buttler.webp', formerTeam: 'RR', t20Rating: 94, fairVal: 14.5 },
  { id: 10, name: 'Pat Cummins', role: 'Bowler', country: '🇦🇺 Australia', basePrice: 2, caps: 42, wickets: 61, economy: 9.1, avg: 28.3, grade: 'A', bg: 'from-yellow-800 to-yellow-600', photo: '/players/pat-cummins.webp', formerTeam: 'SRH', t20Rating: 92, fairVal: 15.0 },
  { id: 11, name: 'Ravindra Jadeja', role: 'All-Rounder', country: '🇮🇳 India', basePrice: 2, caps: 236, avg: 26.6, sr: 127.4, wickets: 132, grade: 'A', bg: 'from-pink-900 to-pink-700', photo: '/players/jadeja.webp', formerTeam: 'CSK', t20Rating: 90, fairVal: 13.5 },
  { id: 12, name: 'David Warner', role: 'Batsman', country: '🇦🇺 Australia', basePrice: 1, caps: 184, avg: 41.6, sr: 139.9, runs: 6565, grade: 'B+', bg: 'from-amber-900 to-amber-700', photo: '/players/david-warner.webp', formerTeam: 'DC', t20Rating: 88, fairVal: 10.0 },
...
const teams = [
  { id: 'MI', name: 'Mumbai Indians', color: '#004BA0', light: '#1A7FE8', emoji: '🐂💰', budget: 100 },
  { id: 'CSK', name: 'Chennai Super Kings', color: '#FFB800', light: '#FFD055', emoji: '🦁👑', budget: 100 },
  { id: 'RCB', name: 'Royal Challengers Bengaluru', color: '#CC0000', light: '#FF3333', emoji: '🐯⚡', budget: 100 },
  { id: 'KKR', name: 'Kolkata Knight Riders', color: '#7B2FBE', light: '#A855F7', emoji: '⚔️🛡️', budget: 100 },
  { id: 'DC', name: 'Delhi Capitals', color: '#0078BC', light: '#22AAFF', emoji: '🦅🏛️', budget: 100 },
  { id: 'PBKS', name: 'Punjab Kings', color: '#C8102E', light: '#FF3355', emoji: '👑🦚', budget: 100 },
  { id: 'RR', name: 'Rajasthan Royals', color: '#E91E8C', light: '#FF55BB', emoji: '🐪👑', budget: 100 },
  { id: 'SRH', name: 'Sunrisers Hyderabad', color: '#FF6600', light: '#FF9933', emoji: '☀️🌅', budget: 100 },
  { id: 'GT', name: 'Gujarat Titans', color: '#1A3A6B', light: '#2B5FBF', emoji: '⚡🏔️', budget: 100 },
  { id: 'LSG', name: 'Lucknow Super Giants', color: '#00B4D8', light: '#48CAE4', emoji: '🚀🌙', budget: 100 }
];
...
module.exports = { samplePlayers, teams, userAccounts };
